...
export default function ThirdSection(){
  ...
  useEffect(() => {
    ...
    api.on("select", () => {
      console.log(api.slideNodes()[api.selectedScrollSnap()])
    })
  }, [api])
  ...
  return (
    <div className="flex flex-col items-center h-screen bg-black gap-12">
      ...
      <Carousel className="w-[69%] md:w-1/2" setApi={setApi}> 
        <CarouselContent className="-ml-4 text-playfair">
            <CarouselItem className="basis-full md:basis-2/5">
              <Card className="flex flex-col justify-evenly p-4 h-96">
              <CardHeader className="p-0">
                ...
                <button className="self-start border-black font-bold text-sm border-2 rounded-lg p-1.5">View Course</button>
              </Card>
            </CarouselItem>
            <CarouselItem className="basis-full md:basis-2/5">
              <Card className="flex flex-col justify-evenly p-4 h-96">
