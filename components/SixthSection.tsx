  ...
  return (
    <div className="flex flex-col items-center justify-center bg-darkWhite h-screen md:flex-row">
      <div className="flex flex-col gap-4 md:w-2/5">
        <h1 className="text-5xl font-bold font-playfair">It's Easy To Start</h1>
        <h2 className="w-fit py-2 px-4 bg-yellow-main rounded-3xl text-3xl font-bold italic border-2 border-lightBlack">Learning</h2>
        <p className="text-p-color font-semibold font-playfair">Our Sing-In Process Let's Start Your Learning Journey Without Much Hassle. Our Aim Is To Create A Great Learning Experience For You.</p>
